                  ...
                  <table className="prod-table">
                     ...
                     <tbody>
                        <tr>
                           <td>
                              <div className="prod-table-item col-group">
                                 ...
                                 <div className="txt-wrap row-group">
                                    ...
                                    <p className="prod-table-item-option mb">
                                       <strong className="red">환불요청</strong>
                                    </p>
                                 </div>
                              </div>
                           </td>
                           <td className="top">
                              <div className="prod-item-order-group row-group">
                                 <Link to="/my-page/refund/detail" className="prod-item-order-number">
                                    A12345678910
                                 </Link>
                           ...
                           <td>
                              <div className="prod-table-btn-group row-group">
                                 <button className="prod-table-btn black">
                                    요청취소
                                 </button>
                                 <Link to="/my-page/refund/detail" className="prod-table-btn">
                                    상세보기
                                 </Link>
                              </div>
                           </td>
                        ...
                        <tr>
                           ...
                           <td className="top">
                              <div className="prod-item-order-group row-group">
                                 <a href="mypage_02_01_02.html" className="prod-item-order-number">
                                    A12345678910
                                 </a>
                                 <p className="prod-item-txt">
                                    2024.12.01 08:00
