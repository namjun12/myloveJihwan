...
// data
// import { jcDetail, ecDetail, mrDetail, feDetail, aeDetail, ref13Data, ref29ScoreResult, Ref33DetailText, ref34ToGrowth } from '../../../data/mindInsightResult';
...
/* 페이지 공통 */
.main {  position: relative; max-width: 1560px; width:100%; padding-top: 100px;}
...
.page-num { font-size: 30px; font-weight: 500; color: #707070; position: absolute; top:0; right: 0; }
...
/* cover */
.main.cover { max-width: 100%; padding-top: 0px;}
...
.result-score { position: relative; width: 100%; height: 64px; border-radius: 32px; background: #e4e4e4; }
...
const PageContainer = ({ inspectId, name, phone, resultPageData }) => {
   ...
   useEffect(() => {
      ...
      //             // iOS에서 더 안정적인 렌더링을 위한 설정
      //             backgroundColor: '#FFFFFF',
      //             logging: true, // 디버깅을 위해 활성화
      //             onclone: (clonedDoc) => {
      //                const clonedElement = clonedDoc.querySelector(element.tagName);
      //                if (clonedElement) {
      ...
      //             setPdfDownload(Math.ceil(((i + 1) / printPageRefs.length) * 100))
      //          } catch (error) {
      //             console.error('PDF 이미지 추가 중 오류:', error);
      //          }
      //       }

      //       // ========== 다운로드 ========== 
      //       alert('v0148')
      //       pdf.save(`insight_pdf_file_${inspectId}.pdf`);

      //       // // ========== 서버로 전송 ========== 
      //       // const pdfBlob = pdf.output('blob');
      //       // // 서버로 보낼 FormData 생성
      //       // const formData = new FormData();
      //       // formData.append('id', inspectId);
      //       // formData.append('name', name);
      //       // formData.append('phone', phone);
      //       // formData.append('pdf_file', pdfBlob, `insight_pdf_file_${inspectId}.pdf`); // 파일 이름 지정
      //       // try {
      //       //    // 서버로 전송
      //       //    const response = await axios.post(`${process.env.REACT_APP_API_URL}/inspect/insight/save/pdf`, formData, {
      //       //       headers: {
      ...
      //       //    // alert('파일 전송 완료')
      //       //    navigate('/mind-insight-test/done')
      //       // } catch (error) {
